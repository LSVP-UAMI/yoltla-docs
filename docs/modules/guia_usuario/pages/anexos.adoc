...
La cantidad de hilos que se crearán durante la ejecución de un programa de memoria compartida “OPENMP” es controlada en el archivo de entrada de la tarea o por medio de la variable de ambiente OMP_NUM_THREADS (ver sección xref:anexos#ejemplos_scripts[Ejemplos de scripts]).
